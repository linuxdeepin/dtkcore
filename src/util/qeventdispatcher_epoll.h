...
#ifndef QEVENTDISPATCHER_EPOLL_P_H
#define QEVENTDISPATCHER_EPOLL_P_H
...
public:
    explicit QEventDispatcherEpoll(QObject *parent = nullptr);
...
#endif // QEVENTDISPATCHER_EPOLL_P_H
