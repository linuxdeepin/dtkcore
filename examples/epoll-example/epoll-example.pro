...
INCLUDEPATH += .
QT+= core core-private widgets testlib
...
include($$PWD/../../src/util/private/private.pri)

# Input
HEADERS += \
    $${PWD}/../../src/dtkcore_global.h \
    $${PWD}/../../src/util/dthreadutils.h \
    $${PWD}/../../src/util/qeventdispatcher_epoll.h

SOURCES += \
    $${PWD}/../../src/util/dthreadutils.cpp \
    $${PWD}/../../src/util/qeventdispatcher_epoll.cpp \
    main.cpp
