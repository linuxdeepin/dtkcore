...
{
    auto group = DSettingsGroup::fromJson(QString(), basicGroup);
...
{
    auto group = DSettingsGroup::fromJson(QStringLiteral("prefix"), basicGroup);
    ASSERT_NE(group, nullptr);
...
{
    auto parent = DSettingsGroup::fromJson(QString(), basicGroup);
    auto child = DSettingsGroup::fromJson(QStringLiteral("parent"), basicGroup);
