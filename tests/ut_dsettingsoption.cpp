...
{
    auto opt = DSettingsOption::fromJson(QStringLiteral("prefix"), jsonObj);
...
{
    jsonObj["default"] = 42;
    auto opt = DSettingsOption::fromJson(QStringLiteral("grp"), jsonObj);
    ASSERT_NE(opt, nullptr);
...
{
    auto opt = DSettingsOption::fromJson(QStringLiteral("group1"), jsonObj);
    ASSERT_NE(opt, nullptr);
