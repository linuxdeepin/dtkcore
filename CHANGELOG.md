...
- Make DConfig fully functional on Windows
...
- Add dev-tools package dependencies to DTK dev packages

## [6.7.47] - 2026-07-28

### Added

- Add null pointer guard for distributionInfo

### Fixed

- Build error on Windows
- Fix(CI): broken cppcheck
- Improve Windows settings backend and thread safety

## [6.7.46] - 2026-07-16

### Fixed

- Preserve float literal type in JSON config values

## [6.7.45] - 2026-07-09

### Fixed

- Fix serial comparison logic in DConfigCache setValue
